...
<div class="container">
    <h2>Baybayin Quiz</h2>
    <form id="quizForm">
    <img src="../images/baybayin_Pa.svg"><img src="../images/baybayin_Na.svg"><img src="../images/baybayin_Ga.svg">
    <?php
    // Fetch questions for Quiz 1 only
    $sql = "SELECT * FROM quizzes WHERE QuizID = 3"; // Assuming Quiz 1 corresponds to Lesson 1
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // No need to increment question number since it's not being used for navigation
        }
