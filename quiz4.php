...
<div class="container">
    <h2>Baybayin Quiz</h2>
    <form id="quizForm">
    <img src="../images/baybayin_Ma.svg"><img src="../images/baybayin_Sa.svg"><img src="../images/baybayin_Ka.svg">
    <?php
// Fetch questions for Quiz 1 only
$sql = "SELECT * FROM quizzes WHERE QuizID = 4"; // Assuming Quiz 1 corresponds to Lesson 1
